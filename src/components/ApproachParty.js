    ...
    return (
        <div className="slider-container approach-show">
            ...
            <div className="approach-show-container">
                ...
                <button onClick={() => props.showImage("/location/party1.png")} className="approach-preview"></button>
                <p>
                ...
                <button onClick={() => props.showImage("/location/party2.png")} className="approach-preview"></button>
                <p>
                    Na widocznym na zdjęciu skrzyżowaniu skręcamy w prawo.
                </p>
                <button onClick={() => props.showImage("/location/party3.png")} className="approach-preview"></button>
                <p>
                ...
                <button onClick={() => props.showImage("/location/party4.png")} className="approach-preview"></button>
                <p>
                    Na skrzyżowaniu z ulicą Gostyńską, jedziemy w prawo.
                </p>
                <button onClick={() => props.showImage("/location/party5.png")} className="approach-preview"></button>
                <p>
                    Natychmiast potem znajdziemy się przed rozwidleniem dróg. Wybieramy tę po naszej lewej stronie.
                </p>
                <button onClick={() => props.showImage("/location/party6.png")} className="approach-preview"></button>
                <p>
                    Jedziemy prosto do momentu, w którym po naszej prawej stronie ukaże się sporych rozmiarów parking. Skręcamy w prawo.
                </p>
                <button onClick={() => props.showImage("/location/party7.png")} className="approach-preview"></button>
                <p>
                    Wjeżdżamy w drogę oznaczoną znakiem <i>Zakaz ruchu w obu kierunkach</i>. Zakaz ten nas nie dotyczy.
                </p>
                <button onClick={() => props.showImage("/location/party8.png")} className="approach-preview"></button>
                <p>
