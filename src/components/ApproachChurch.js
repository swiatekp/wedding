    ...
    return (
        <div className="slider-container approach-show">
            ...
            <div className="approach-show-container">
                ...
                <button onClick={() => props.showImage(require("../img/location/church1.png"))} className="approach-preview"></button>
                <p>
                ...
                <button onClick={() => props.showImage(require("../img/location/church2.png"))} className="approach-preview"></button>
                <p>
                    Bezpośrednio po skręcie w lewo, należy zająć prawy pas i skręcić w prawo.
            </p>
                <button onClick={() => props.showImage(require("../img/location/church3.png"))} className="approach-preview"></button>
                <p>
                    Kościół znajduje się na wprost.
            </p>
                <button onClick={() => props.showImage(require("../img/location/church4.png"))} className="approach-preview"></button>
            </div>
            <p>
